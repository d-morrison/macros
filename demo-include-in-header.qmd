...
- **HTML/RevealJS**: MathJax processes the header — only `\def`/`\newcommand` macros are recognized; `\providecommand` macros are silently ignored. The example table below uses only `\def`-based macros.
