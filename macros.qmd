...
<!-- Multiplicative "factors": one covariate pattern vs. the baseline pattern. -->
<!-- Distinct from ratios (\ror, \hazratio, ...), which compare two explicit patterns. -->
<!-- Factors currently share the base symbol \theta with ratios and render identically; -->
<!-- per d-morrison/macros#56 the ratio base will move to koppa while factors keep \theta, -->
<!-- so tracking them as separate macros now lets that switch happen in one place. -->
\def\factor{\theta}
